...
2.  **Frontend (`main.tsx`)**: A React component that utilizes the shared `ColumnView` component to display the hierarchical file listing. It shows file metadata and allows users to either download extracted files or open them with other handlers within FileTool.
