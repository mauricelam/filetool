 ...
 * @returns {Ext4Node}
 */
export function parse_ext4(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_ext4(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {Uint8Array}
 */
export function read_ext4_file(data, path) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.read_ext4_file(ptr0, len0, ptr1, len1);
    if (ret[3]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ext4-wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
